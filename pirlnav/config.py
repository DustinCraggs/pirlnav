...
_CONFIG.IL.BehaviorCloning.encoder_freeze_updates = 0
_CONFIG.IL.BehaviorCloning.encoder_warmup_updates = 0
...
_CONFIG.POLICY.PVR_ENCODER = CN()
_CONFIG.POLICY.PVR_ENCODER.num_heads = 4
_CONFIG.POLICY.PVR_ENCODER.num_layers = 2
_CONFIG.POLICY.PVR_ENCODER.dropout = 0.1
