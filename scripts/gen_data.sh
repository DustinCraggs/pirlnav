...
python run.py \
    ...
    TASK_CONFIG.DATASET.FILTER_EXISTING_PATH completed_eps_splits/edge_fix_running_splits/completed_eps_0.txt \
    # TASK_CONFIG.DATASET.FILTER_EXISTING_PATH split_0_work_splits/completed_eps_0.txt \
